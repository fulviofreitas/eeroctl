...
Credentials are stored in `~/.config/eero-client/cookies.json`.
...
|------|----------|---------|
| Credentials | `~/.config/eero-client/cookies.json` | Session token storage |
| Settings | `~/.config/eero-client/config.json` | User preferences |
